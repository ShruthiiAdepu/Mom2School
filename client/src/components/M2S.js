...
import '../styles/M2S.css';

const M2S = () => {
  return (
    <div className="m2s-container">
      {/* Navbar (Header) */}
      ...
      <section className="hero">
        <h2>A New Way to Send Love at Lunchtime</h2>
        <p>Don't rush under the sun. Let us pick up your lunchbox and deliver it safely to your child — warm, fresh, and on time.</p>
      ...
      <section className="how-it-works" id="how-it-works">
        ...
        <div className="steps">
          <div className="step">
            ...
            <h4>Pack</h4>
            <p>Prepare your child's lunch and keep it ready before pickup time.</p>
          </div>
          <div className="step">
            <div className="icon">🚴‍♂️</div>
            <h4>Pick Up</h4>
            <p>Our rider collects boxes on a smartly timed route from nearby homes.</p>
          </div>
          <div className="step">
            <div className="icon">🎒</div>
            <h4>Deliver</h4>
            <p>Lunch reaches your child safely and on time at their school gate.</p>
          </div>
        </div>
      </section>
